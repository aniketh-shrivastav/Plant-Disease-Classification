...
def main():
    ap = argparse.ArgumentParser(description="Predict Apple disease (binary) using scratch Logistic Regression artifacts")
    ap.add_argument("--image", required=True, type=str)
    ap.add_argument("--model_dir", type=str, default=str(Path("outputs")/"apple_logreg"))
    args = ap.parse_args()
