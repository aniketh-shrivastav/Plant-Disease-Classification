...
def parse_args():
    ap = argparse.ArgumentParser(description="Train scratch Linear SVM for Dragon Fruit (healthy vs diseased) using HOG+HSV")
    ap.add_argument("--data_dir", type=str, default=str(Path("Dragon Fruit (Pitahaya)")/"Original Images"))
    ap.add_argument("--output_dir", type=str, default=str(Path("outputs")/"dragon_svm"))
...
def main():
    ...
    print("Dragon Fruit Linear SVM training complete.")
