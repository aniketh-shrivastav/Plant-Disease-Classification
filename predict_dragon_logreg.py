...
def main():
    ap = argparse.ArgumentParser(description="Predict Dragon Fruit disease (binary) using scratch Logistic Regression artifacts")
    ap.add_argument("--image", required=True, type=str)
    ap.add_argument("--model_dir", type=str, default=str(Path("outputs")/"dragon_logreg"))
    args = ap.parse_args()
