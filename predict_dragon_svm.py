...
def main():
    ap = argparse.ArgumentParser(description="Predict Dragon Fruit disease with scratch Linear SVM")
    ap.add_argument("--image", required=True, type=str)
    ap.add_argument("--model_dir", type=str, default=str(Path("outputs")/"dragon_svm"))
    args = ap.parse_args()
