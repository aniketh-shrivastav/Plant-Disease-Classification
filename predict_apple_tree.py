...
def main():
    ap = argparse.ArgumentParser(description="Predict Apple disease with scratch Decision Tree")
    ap.add_argument("--image", required=True, type=str)
    ap.add_argument("--model_dir", type=str, default=str(Path("outputs")/"apple_tree"))
    args = ap.parse_args()
