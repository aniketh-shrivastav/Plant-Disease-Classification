...
def main():
    ap = argparse.ArgumentParser(description="Predict rhizome disease with scratch Linear SVM")
    ap.add_argument("--image", required=True, type=str)
    ap.add_argument("--model_dir", type=str, default=str(Path("outputs")/"rhizome_svm"))
    args = ap.parse_args()
